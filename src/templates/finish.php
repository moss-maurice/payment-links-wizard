<?php include __DIR__ . '/partials/header.php'; ?>
                <input type="hidden" name="next_stage" value="remove" />
                ...
                <div class="card card-md">
                    <div class="card-body text-center py-4 p-sm-5">
                        ...
                        <p class="text-muted">Форма генерации ссылок доступа в разеделе модулей в панели управления администратора.</p>
                        <p class="text-muted">В панели администратора можно более тонко настроить модуль и плагин.</p>
