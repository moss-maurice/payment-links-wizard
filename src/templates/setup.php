<?php include __DIR__ . '/partials/header.php'; ?>
                ...
                <input type="hidden" name="next_stage" value="finish" />
                ...
                <div class="card card-md">
                    ...
                    <div class="hr-text hr-text-center hr-text-spaceless">Настройки</div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label">Префикс ссылки</label>
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-4">
                        <div class="progress">
                            <div class="progress-bar" style="width: 50%" role="progressbar" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100" aria-label="50% Complete">
