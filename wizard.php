        ...
        <div class="container container-tight py-4">
            ...
            <form method="post" action="">
                <div class="card card-md">
                    <div class="card-body text-center py-4 p-sm-5">
                        <svg id="b59c9f89-c93e-413f-a14b-776784e615e2" data-name="Layer 1"
                            xmlns="http://www.w3.org/2000/svg" height="120" viewBox="0 0 1075.51587 646.89913">
                            <title>sign_in</title>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-62.24207 -126.55043)" fill="#206bc4" />
                            ...
                            <path
                                ...
                                transform="translate(-62.24207 -126.55043)" fill="#575a89" />
                            <path
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="page[pagetitle]" class="form-control" autocomplete="off"
                                    required
                                    value="<?= (isset($_POST['page']['pagetitle']) ? $_POST['page']['pagetitle'] : 'Онлайн-оплата') ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Псевдоним</label>
                            <div class="input-group input-group-flat">
                                <input type="text" name="page[alias]" class="form-control" autocomplete="off" required
                                    value="<?= (isset($_POST['page']['alias']) ? $_POST['page']['alias'] : 'online-oplata') ?>">
                            </div>
                        </div>
                        <div>
                            ...
                            <select name="page[template]" class="form-select mb-0">
                                ...
                                <option value="<?= $template['id']; ?>"
                                    <?= (isset($_POST['page']['template']) && (intval($_POST['page']['template']) === intval($template['id'])) ? ' selected' : '') ?>>
            ...
            <form method="post" action="">
                <div class="card card-md">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="plugin[placeholder]" class="form-control" autocomplete="off"
                                    required value="payButton">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="plugin[testMerchant]" class="form-control" autocomplete="off"
                                    value="">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="plugin[testToken]" class="form-control" autocomplete="off"
                                    value="">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="plugin[productMerchant]" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="text" name="plugin[productToken]" class="form-control" autocomplete="off"
                                    value="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-4">
                        <div class="progress">
                            <div class="progress-bar" style="width: 66%" role="progressbar" aria-valuenow="66"
                                aria-valuemin="0" aria-valuemax="100" aria-label="66% Complete">
                ...
                <div class="card card-md">
                    <div class="card-body text-center py-4 p-sm-5">
                        ...
                        <p class="text-muted"><a class="btn btn-info"
                                href="<?= "{$_SERVER['REQUEST_SCHEME']}://{$_SERVER['HTTP_HOST']}/{$_POST['page']['alias']}/"; ?>"
                                target="_blank">Страницу тестовой оплаты</a></p>
                        <p class="text-muted">В панели администратора можно более тонко настроить платежную страницу и
                            плагин.</p>
                    ...
                    <div class="col-4">
                        <div class="progress">
                            <div class="progress-bar" style="width: 100%" role="progressbar" aria-valuenow="100"
                                aria-valuemin="0" aria-valuemax="100" aria-label="100% Complete">
